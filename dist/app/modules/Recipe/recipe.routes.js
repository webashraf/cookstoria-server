...
router.post("/create-recipe", multer_config_1.multerUpload.single("image"), parseBody_1.parseBody, (0, validateRequest_1.default)(recipe_validation_1.recipeValidations.recipeValidationSchema), recipe_controller_1.recipeController.createRecipe);
